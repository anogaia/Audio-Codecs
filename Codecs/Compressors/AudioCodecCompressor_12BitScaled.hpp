#ifndef __AUDIOCODECCOMPRESSOR_12BITSCALED_HPP__
#define __AUDIOCODECCOMPRESSOR_12BITSCALED_HPP__ 1

#include "../AudioCodec.hpp"


template <typename AudioSampleType>
class AudioCodecCompressor_12BitScaled : public AudioCodecCompressor<AudioSampleType> {
public:
...
#endif // __AUDIOCODECCOMPRESSOR_12BITSCALED_HPP__
